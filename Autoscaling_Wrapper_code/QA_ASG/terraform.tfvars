...
QA_Frontend_security_name                       = "QA_Frontend-Frontend-sg"
QA_Frontend_security_description                = "Security group for QA_Frontend-Frontend-API"
...
QA_Frontend_inbound_ports                       = [
  ...
  { port                                = 22, protocol = "tcp", security_group_ids = "sg-0f470a22a92136557" },     #  QA_Frontend-Frontend-lb-sg ID
...
QA_Frontend_template_name                       = "QA_Frontend-Frontend-template"
QA_Frontend_template_description                = "Template for QA_Frontend-Frontend"
...
QA_Frontend_target_group_name                   = "QA_Frontend-Frontend-TG"
...
QA_Frontend_autoscaling_group_name              = "QA_Frontend_Frontend_ASG"
QA_Frontend_min_size                            = 1
QA_Frontend_max_size                            = 2
QA_Frontend_desired_capacity                    = 1
QA_Frontend_subnet_ids                          = ["subnet-04c0c823118f48202"]   #QA_Frontend-Frontend Pvt ID
QA_Frontend_tag_key                             = "Name"
QA_Frontend_tag_value                           = "QA_Frontend_Frontend_ASG"
